...
const VALORES_VALIDOS = {
  ...
  area_tecnica: ['obrigacoes_acessorias', 'impostos_tributos', 'gps_inss',
    'darf_recolhimento', 'lancamento', 'calculo_apuracao',
    'importacao_integracao', 'relatorios', 'parametrizacao',
    'infraestrutura', 'outros', null],
