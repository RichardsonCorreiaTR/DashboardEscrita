/**
 * api.js (v2) - Cliente HTTP para comunicacao com a API REST
 *
 * Identico ao v1: as rotas /api/* sao as mesmas (backend compartilhado).
 */
...
const API = (() => {
  ...
  function obterSaude() { return get('/saude', 3000); }
